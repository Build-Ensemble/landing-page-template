    ...
    <footer id="footer" className={className}>
      ...
      <section className="container py-8 border-t border-gray-200 mt-10">
        <div className="grid grid-cols-2 md:grid-cols-4 xl:grid-cols-6 gap-x-12 gap-y-8 ">
          <div className="col-span-full xl:col-span-2 flex items-center gap-3 mb-6 xl:mb-0">
          ...
          <div className="flex flex-col gap-3">
            ...
            <a
              rel="noreferrer noopener"
              href="https://www.linkedin.com/company/ensemble-books/"
              target="_blank"
          ...
          <div className="flex flex-col gap-3">
            ...
            <a
              href="mailto:simon@tryensemble.com?subject=ensemble%20inquiry"
